...
$opt_name = 'geniusuran_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'geniusuran' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Theme Options', 'geniusuran' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header Settings', 'geniusuran' ),
		'id'               => 'site_settings_header',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Settings ', 'geniusuran' ),
		'fields'           => array(
			array(
				'id'           => 'phone',
				'type'         => 'text',
				'url'          => true,
				'title'        => esc_html__("Phone Number", 'geniusuran' ),
				'compiler'     => 'true',
				'desc'         => esc_html__( 'phone', 'geniusuran' ),
				'subtitle'     => esc_html__( 'Insert phone', 'geniusuran' ),
				'preview_size' => 'full',
                'default'  => '',
			),
			array(
				'id'       => 'email',
				'type'     => 'text',
				'title'    => esc_html__( 'Site Email', 'geniusuran' ),
				'subtitle' => esc_html__( 'Insert Email', 'geniusuran' ),
				'desc'     => esc_html__( 'Email', 'geniusuran' ),
				'default'  => '',
			),
            array(
                'id'       => 'header_image',
                'type'     => 'media',
                'title'    => esc_html__( 'Site Heading', 'geniusuran' ),
                'subtitle' => esc_html__( 'Insert Email', 'geniusuran' ),
                'desc'     => esc_html__( 'Email', 'geniusuran' ),
                'default'  => '',
            ),
